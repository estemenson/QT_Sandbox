...
class Grid2(QWidget):
    ...
    def initUI(self):
        ...
        self.grid = MyGrid()
        self.borderLayout.addWidget(self.grid, BorderLayout.Center)
        label_n = self.createLabel("\n\n\n")
        self.borderLayout.addWidget(label_n, BorderLayout.North)

        label_w = self.createLabel("            ")
        self.borderLayout.addWidget(label_w, BorderLayout.West)

        label_e = self.createLabel("            ")
        self.borderLayout.addWidget(label_e, BorderLayout.East)

        label_s = self.createLabel("\n\n\n")
        self.borderLayout.addWidget(label_s, BorderLayout.South)
        #self.grid.addWidget(Scribble2())
        self.setLayout(self.borderLayout)
