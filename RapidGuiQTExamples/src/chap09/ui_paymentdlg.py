...
# Form implementation generated from reading ui file 'C:\Users\hotsoft\Downloads\pyqt\chap09\paymentdlg.ui'
#
...
class Ui_PaymentDlg(object):
    def setupUi(self, PaymentDlg):
        ...
        self.invoiceNumSpinBox.setProperty(_fromUtf8("value"), 1000000)
